System.register(['angular2/core', 'angular2/http', './youtube.service'], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, http_1, youtube_service_1;
    var TubeComponent;
    return {
        setters:[
            function (core_1_1) {
        ...
        execute: function() {
            TubeComponent = (function () {
                function TubeComponent(_youTubeService) {
